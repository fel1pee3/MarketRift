...
try {
  for (const name of ['001_initial.sql', '002_full_product.sql', '003_first_slice.sql', '004_account_security.sql', '005_review_analysis.sql', '006_github_issues.sql', '007_steam_reviews.sql', '008_web_pages.sql', '009_page_monitoring.sql', '010_github_discussions.sql', '011_b2b_review_rights.sql', '012_b2b_analysis_rights.sql']) {
